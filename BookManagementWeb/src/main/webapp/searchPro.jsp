...
String publisherSearchName = request.getParameter("publisherSearch"); 
ArrayList<BookVO> searchList = dao.searchPro(publisherSearchName); 
if(searchList.isEmpty()){
	%>
	<div class="content-container"> 
	    <h2 style = "text-align: center">검색 결과가 존재하지 않습니다.</h2> 
...
<form action="" class="form-display"> 
	...
	String[] date = searchList.get(i).getDate().split("-");
		String pub = searchList.get(i).getPublisher(); 
	%>
	<tr>
